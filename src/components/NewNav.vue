    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-md-auto gap-2">
        <li class="nav-item rounded">
          <router-link to="/"><a class="nav-link active" aria-current="page"><i class="bi bi-house-fill me-2"></i>Home</a></router-link>
        </li>
        <li class="nav-item rounded">
          <a class="nav-link" href="/cart"><i class="bi bi-people-fill me-2"></i>Cart</a>
        </li>
        <li class="nav-item rounded">
          <router-link to="/AllAlbums"><a class="nav-link"><i class="bi bi-telephone-fill me-2"></i>Albums</a></router-link>
        </li>
        <li class="nav-item dropdown rounded">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            <router-link to="/login"><a class="dropdown-item">Login</a></router-link>
            <router-link to="/signup"><li><a class="dropdown-item">signup</a></li></router-link>
            <li>
